...
invoicing specifications. If one can create a valid and syntactically correct EN16931 based UBL-format; the threshold for implementing PUF should be negligible.
...
|2.0 |2021-05-04 |Second version published
