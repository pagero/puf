Aggregate AdditionalDocumentReference is in EN16931 based specifications used to reference reference a supporting document. These can be either be provided as a
