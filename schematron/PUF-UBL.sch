...
<schema queryBinding="xslt2" schemaVersion="iso" xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:u="utils">
    ...
    <pattern>
        ...
        <rule context="ubl-creditnote:CreditNote | ubl-invoice:Invoice">
            <assert flag="fatal" id="PUF-R001" test="starts-with(normalize-space(cbc:CustomizationID/text()), 'urn:pagero.com:puf:billing:1.0') or starts-with(normalize-space(cbc:CustomizationID/text()), 'urn:cen.eu:en16931:2017#compliant#urn:fdc:peppol.eu:2017:poacc:billing:3.0#conformant#urn:pagero.com:puf:billing:1.0')">[PUF-R001]-Customization identifier MUST have the value 'urn:pagero.com:puf:billing:1.0' or 'urn:cen.eu:en16931:2017#compliant#urn:fdc:peppol.eu:2017:poacc:billing:3.0#conformant#urn:pagero.com:puf:billing:1.0'.</assert>
